...
namespace _099_DataGridView_C
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.Columns[1].DefaultCellStyle.SelectionBackColor = Color.Blue;
            ...
            dataGridView1.Columns[3].DefaultCellStyle.ForeColor = Color.DarkGray;
            dataGridView1.Columns[3].DefaultCellStyle.SelectionBackColor = Color.Gray;
            dataGridView1.Columns[3].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;


            dataGridView1.Columns[4].DefaultCellStyle.ForeColor = Color.LightGreen;
            dataGridView1.Columns[4].DefaultCellStyle.SelectionBackColor = Color.DeepSkyBlue;
        }
